...
{
    cmsUInt8Number* real_ptr = (cmsUInt8Number*) _cmsMallocZero(sizeof(XMatShaper8Data) + 32);
...
static
XMatShaper8Data* SetMatShaper(cmsToneCurve* Curve1[3], cmsMAT3* Mat, cmsVEC3* Off, cmsToneCurve* Curve2[3])
{
    XMatShaper8Data* p;
    int i, j;
